...
export function usePrepCalculator({ prises, sessionActive, isClient }: PrepCalculatorInput): PrepCalculatorResult {

  const calculator = useMemo(() => {
    const now = new Date(); // Use a fresh date for each calculation
